...
## API
De [API](https://webcomponenten.omgeving.vlaanderen.be/doc/VlProgressBar.html) bevat een overzicht van de ondersteunde attributen en een beschrijving van de beschikbare functies.
